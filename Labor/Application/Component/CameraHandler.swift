...
class PhotoHandler: NSObject{
    ...
    func showActionSheet(vc: UIViewController) {
        ...
        //        actionSheet.addAction(UIAlertAction(title: "delete".localized(), style: .default, handler: { (alert:UIAlertAction!) -> Void in
        //            self.removePhoto()
        //        }))
    ...
    func grantCameraPermissionIfNeeded() {
